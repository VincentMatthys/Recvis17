...
% fold the w vetor, which may have been com puted with spatial subdivisions
...
for k = 1:length(perm)
  ...
  axis image ;
  title(sprintf('Visual word %d: rank: %d, weight * count: %g', word0, k, scores(k)), 'fontsize', 20);
