...
\begin{figure}[ht!]
	...
	\label{fig_1D1_aeroplanes_ranks}
\end{figure}
...
\begin{figure}[ht!]
	...
	\caption{Ranking of a subset of 36 testing images with \( C = 10\) : \(24\) over \(36\) images are correctly retrieved.}
	\label{fig_1D1_motorbikes_ranks}
\end{figure}

\begin{figure}[ht!]
	\centering
	\includegraphics[width = 1.0\textwidth]{1D1_persons_C_10}
	\caption{Ranking of a subset of 36 testing images with \( C = 10\) : \(33\) over \(36\) images are correctly retrieved.}
	\label{fig_1D1_persons_ranks}
\end{figure}
